...
<form id="form1" runat="server">
    <div>
        ...
        <rsweb:ReportViewer ID="rptViewerCurtailmentReceiptDuringSession" runat="server" Font-Size="8pt" Height="650px" Width="100%" repo ShowPrintButton="True" AsyncRendering="False" SizeToReportContent="True">
