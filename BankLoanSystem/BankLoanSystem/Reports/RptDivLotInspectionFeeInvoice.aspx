<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptDivLotInspectionFeeInvoice.aspx.cs" Inherits="BankLoanSystem.Reports.RptDivLotInspectionFeeInvoice" %>
...
<form id="form1" runat="server">
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="rptViewerLotInspectionFeeInvoice" runat="server" Font-Size="8pt" Height="100%" Width="100%" repo ShowPrintButton="True">
