<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptDivIndividualCurtailmentSummary.aspx.cs" Inherits="BankLoanSystem.Reports.RptDivIndividualCurtailmentSummary" %>
...
<form id="form1" runat="server">
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="rptViewerIndividualCurtailmentSummary" runat="server" Font-Size="8pt" Height="100%" Width="100%" repo ShowPrintButton="True">
