...
<form id="form1" runat="server">
    <div>
        ...
        <rsweb:ReportViewer ID="rptViewerMonthlyLoanFeeReceipt" runat="server" Font-Size="8pt" Height="100%" Width="100%" repo ShowPrintButton="True" SizeToReportContent="True">
