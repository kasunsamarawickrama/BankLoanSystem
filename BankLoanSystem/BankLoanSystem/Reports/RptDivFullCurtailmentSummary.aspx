<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptDivFullCurtailmentSummary.aspx.cs" Inherits="BankLoanSystem.Reports.RptDivFullCurtailmentSummary" %>
...
<form id="form1" runat="server">
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="rptViewerFullCurtailmentSummary" runat="server" Font-Size="8pt" Height="100%" Width="100%" repo ShowPrintButton="True">
