...
namespace BankLoanSystem.DAL
{
    ...
    public class BranchAccess
    {
        ...
        public int insertNonRegBranchDetails(CompanyBranchModel nonRegBranch, int userId)
        {
            ...
            paramertList.Add(new object[] { "@branch_address_2", nonRegBranch.MainBranch.BranchAddress2.Trim() });
            paramertList.Add(new object[] { "@state_id", nonRegBranch.MainBranch.StateId });
            paramertList.Add(new object[] { "@city", nonRegBranch.MainBranch.BranchCity.Trim() });
            ...
            paramertList.Add(new object[] { "@email", nonRegBranch.MainBranch.BranchEmail.Trim() });
            paramertList.Add(new object[] { "@phone_num_1", nonRegBranch.MainBranch.BranchPhoneNum1.Trim() });
            paramertList.Add(new object[] { "@phone_num_2", nonRegBranch.MainBranch.BranchPhoneNum2.Trim() });
            paramertList.Add(new object[] { "@phone_num_3", nonRegBranch.MainBranch.BranchPhoneNum3.Trim() });
            paramertList.Add(new object[] { "@fax", nonRegBranch.MainBranch.BranchFax.Trim() });
            paramertList.Add(new object[] { "@created_date", DateTime.Now });
